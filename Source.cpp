...
int main()
{
	...
	angajat4 = angajat2;
	cout << "		Operator =" << endl;
	if (strcmp(angajat4.getNume(), numeAngajat) == 0) { cout << "Nume CORECT" << endl; }
	...
	if (strcmp(angajat3.getNume(), numeAngajat) == 0)	{		cout << "Nume CORECT" << endl;	}	else	{		cout << "Nume INCORECT" << endl;	}
